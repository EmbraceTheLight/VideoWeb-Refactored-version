...
import (
	...
	"net/http"
	followv1 "vw_gateway/api/v1/user/follow"
...
type FollowService struct {
	...
	log           *log.Helper
	followUsecase *userbiz.FollowUsecase
}

func NewFollowService(logger log.Logger, followUsecase *userbiz.FollowUsecase) *FollowService {
