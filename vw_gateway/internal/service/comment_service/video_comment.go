...
func NewVideoCommentService(vcUsecase videobiz.VideoCommentUsecase, logger log.Logger) *VideoCommentService {
...
func (s *VideoCommentService) CommentVideo(ctx context.Context, req *vcommentv1.CommentVideoReq) (*vcommentv1.CommentVideoResp, error) {
...
func (s *VideoCommentService) UpvoteComment(ctx context.Context, req *vcommentv1.UpvoteCommentReq) (*vcommentv1.UpvoteCommentResp, error) {
