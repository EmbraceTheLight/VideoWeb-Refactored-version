...
const (
	Follow_FollowUser_FullMethodName   = "/vw_gateway.api.v1.follow.Follow/FollowUser"
	Follow_UnfollowUser_FullMethodName = "/vw_gateway.api.v1.follow.Follow/UnfollowUser"
)
...
var Follow_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "vw_gateway.api.v1.follow.Follow",
