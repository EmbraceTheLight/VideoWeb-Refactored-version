...
const (
	Captcha_GetImageCaptcha_FullMethodName = "/gateway.api.v1.user.captcha.Captcha/GetImageCaptcha"
	Captcha_GetCodeCaptcha_FullMethodName  = "/gateway.api.v1.user.captcha.Captcha/GetCodeCaptcha"
)
...
var Captcha_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gateway.api.v1.user.captcha.Captcha",
	...
	Metadata: "v1/user/captcha/captcha.proto",
}
