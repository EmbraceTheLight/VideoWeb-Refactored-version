...
const OperationIdentityLogin = "/gateway.api.v1.user.id.Identity/Login"
const OperationIdentityLogout = "/gateway.api.v1.user.id.Identity/Logout"
const OperationIdentityRegister = "/gateway.api.v1.user.id.Identity/Register"
