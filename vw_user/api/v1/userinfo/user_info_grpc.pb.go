...
const (
	Userinfo_GetUserinfo_FullMethodName         = "/vw_user.api.v1.userinfo.Userinfo/GetUserinfo"
	Userinfo_ModifyEmail_FullMethodName         = "/vw_user.api.v1.userinfo.Userinfo/ModifyEmail"
	Userinfo_ModifyPassword_FullMethodName      = "/vw_user.api.v1.userinfo.Userinfo/ModifyPassword"
	Userinfo_ModifyUserSignature_FullMethodName = "/vw_user.api.v1.userinfo.Userinfo/ModifyUserSignature"
	Userinfo_ForgetPassword_FullMethodName      = "/vw_user.api.v1.userinfo.Userinfo/ForgetPassword"
	Userinfo_ModifyUsername_FullMethodName      = "/vw_user.api.v1.userinfo.Userinfo/ModifyUsername"
)
...
var Userinfo_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "vw_user.api.v1.userinfo.Userinfo",
	...
	Metadata: "v1/userinfo/user_info.proto",
}
