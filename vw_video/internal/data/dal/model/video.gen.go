...
type Video struct {
	...
	Tags         string         `gorm:"column:tags;type:varchar(100);comment:视频标签，以英文逗号分隔" json:"tags"`                                                                      // 视频标签，以英文逗号分隔
	...
	CoverPath    string         `gorm:"column:cover_path;type:varchar(256);not null;comment:视频封面路径" json:"cover_path"`                                                       // 视频封面路径
}
