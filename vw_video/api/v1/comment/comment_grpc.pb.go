...
const (
	VideoComment_PublishComment_FullMethodName            = "/video.v1.comment.VideoComment/PublishComment"
	VideoComment_GetCommentList_FullMethodName            = "/video.v1.comment.VideoComment/GetCommentList"
	VideoComment_GetCommentReplies_FullMethodName         = "/video.v1.comment.VideoComment/GetCommentReplies"
	VideoComment_UpvoteComment_FullMethodName             = "/video.v1.comment.VideoComment/UpvoteComment"
	VideoComment_UpvoteCommentRevert_FullMethodName       = "/video.v1.comment.VideoComment/UpvoteCommentRevert"
	VideoComment_CheckIfUserUpvotedComment_FullMethodName = "/video.v1.comment.VideoComment/CheckIfUserUpvotedComment"
	VideoComment_GetPublisherId_FullMethodName            = "/video.v1.comment.VideoComment/GetPublisherId"
)
...
type VideoCommentClient interface {
	...
	UpvoteCommentRevert(ctx context.Context, in *UpvoteCommentReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
	...
	GetPublisherId(ctx context.Context, in *GetPublisherIdReq, opts ...grpc.CallOption) (*GetPublisherIdResp, error)
}
...
func (c *videoCommentClient) UpvoteCommentRevert(ctx context.Context, in *UpvoteCommentReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, VideoComment_UpvoteCommentRevert_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *videoCommentClient) GetPublisherId(ctx context.Context, in *GetPublisherIdReq, opts ...grpc.CallOption) (*GetPublisherIdResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPublisherIdResp)
	err := c.cc.Invoke(ctx, VideoComment_GetPublisherId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VideoCommentServer interface {
	...
	UpvoteCommentRevert(context.Context, *UpvoteCommentReq) (*emptypb.Empty, error)
	CheckIfUserUpvotedComment(context.Context, *CheckIfUserUpvotedCommentReq) (*CheckIfUserUpvotedCommentResp, error)
	GetPublisherId(context.Context, *GetPublisherIdReq) (*GetPublisherIdResp, error)
...
func (UnimplementedVideoCommentServer) UpvoteCommentRevert(context.Context, *UpvoteCommentReq) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpvoteCommentRevert not implemented")
}
...
func (UnimplementedVideoCommentServer) GetPublisherId(context.Context, *GetPublisherIdReq) (*GetPublisherIdResp, error) {
...
func _VideoComment_UpvoteCommentRevert_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpvoteCommentReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VideoCommentServer).UpvoteCommentRevert(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VideoComment_UpvoteCommentRevert_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VideoCommentServer).UpvoteCommentRevert(ctx, req.(*UpvoteCommentReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _VideoComment_GetPublisherId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPublisherIdReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VideoCommentServer).GetPublisherId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VideoComment_GetPublisherId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VideoCommentServer).GetPublisherId(ctx, req.(*GetPublisherIdReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VideoComment_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "video.v1.comment.VideoComment",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpvoteCommentRevert",
			Handler:    _VideoComment_UpvoteCommentRevert_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _VideoComment_GetPublisherId_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "v1/comment/comment.proto",
}
